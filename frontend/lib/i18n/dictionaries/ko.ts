...
const ko: Dictionary = {
  ...
  matchInsight: {
    ...
    confidenceHelp: "신뢰도는 현재 근거가 이 평가를 얼마나 뒷받침하는지를 나타냅니다. 확률이 아닙니다.",
    confidenceParts: "신뢰도 구성",
    scoreBreakdown: "점수 세부내역",
    requirementMatrix: "요구사항 매트릭스",
    requirement: "요구사항",
    priority: "우선순위",
    status: "상태",
    evidence: "근거",
    eligible: "자격 충족",
    eligibilityPartial: "부분 충족",
    blocked: "충족 불가",
    mustHave: "필수",
    niceToHave: "우대",
    strong: "강함",
    ...
    missing: "근거 없음",
    statusBlocked: "차단됨",
    noCurrentEvidence: "현재 근거를 찾지 못했습니다",
    evidenceItems: "뒷받침하는 근거 {count}건",
    evidenceItem: "뒷받침하는 근거 1건",
    transferableTitle: "전이 가능한 근거",
    transferableHint: "요구사항을 부분적으로 충족하는 관련 경험입니다. 직접 충족으로 계산되지 않습니다.",
    transferableRelation: "{target}에 부분적으로 관련",
    contradictionsTitle: "상충하는 근거",
    contradictionsHint: "현재 두 출처의 내용이 서로 다릅니다. 지원자에 대한 판단이 아닙니다.",
    sourceA: "첫 번째 출처",
    sourceB: "두 번째 출처",
    trajectoryTitle: "경력 흐름",
    trajectorySTRONG: "뚜렷함",
    trajectoryALIGNED: "부합",
    trajectoryMIXED: "혼재",
    trajectoryWEAK: "약함",
    trajectoryUNKNOWN: "알 수 없음",
    scoreChangeTitle: "적합도 변화",
    scoreChangeFrom: "{previous} → {current}",
    improveTitle: "이 적합도를 높이려면?",
    improveHint: "현재 보유한 근거를 기준으로 합니다. 추가한다고 점수 상승이 보장되지는 않습니다.",
    confSources: "독립 출처",
    confVolume: "근거 분량",
    confCoverage: "요구사항 커버리지",
    confProfile: "프로필 완성도",
    confConsistency: "일관성",
    sourceFILE: "파일",
    sourceURL: "링크",
    sourcePROFILE: "프로필",
    page: "{page}쪽",
    noAnalysis: "이 매치에 대한 고급 분석이 아직 없습니다.",
    dimensionMustHaveSkills: "필수 기술",
    dimensionExperienceDepth: "경험 깊이",
    dimensionRoleSimilarity: "직무 유사도",
    dimensionSeniorityFit: "직급 적합도",
    dimensionProjectEvidence: "프로젝트 근거",
    dimensionLocationWorkMode: "근무지 및 근무 형태",
    dimensionLanguageFit: "언어 적합도",
    dimensionNiceToHave: "우대 사항",
    compareTitle: "비교 인사이트",
    bestTechnicalMatch: "기술 적합도 최고",
    bestSeniorityFit: "직급 적합도 최고",
    fewestMustHaveGaps: "필수 미충족 최소",
