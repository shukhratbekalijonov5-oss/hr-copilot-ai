...
const en = {
  ...
  matchInsight: {
    ...
    confidenceHelp: "Confidence reflects how much current evidence supports this assessment. It is not a probability.",
    confidenceParts: "How confidence was reached",
    scoreBreakdown: "Score breakdown",
    requirementMatrix: "Requirement matrix",
    requirement: "Requirement",
    priority: "Priority",
    status: "Status",
    evidence: "Evidence",
    eligible: "Eligible",
    eligibilityPartial: "Partial",
    blocked: "Blocked",
    mustHave: "Must-have",
    niceToHave: "Nice-to-have",
    strong: "Strong",
    ...
    noCurrentEvidence: "No current evidence found",
    evidenceItems: "{count} supporting evidence items",
    evidenceItem: "1 supporting evidence item",
    transferableTitle: "Transferable evidence",
    transferableHint: "Related experience that partly covers a requirement. It is not counted as a direct match.",
    transferableRelation: "partial relevance to {target}",
    contradictionsTitle: "Conflicting evidence",
    contradictionsHint: "Two current sources state different things. This is not a judgement about the candidate.",
    sourceA: "First source",
    sourceB: "Second source",
    trajectoryTitle: "Career trajectory",
    trajectorySTRONG: "Strong",
    trajectoryALIGNED: "Aligned",
    trajectoryMIXED: "Mixed",
    trajectoryWEAK: "Weak",
    trajectoryUNKNOWN: "Not known",
    scoreChangeTitle: "Match changed",
    scoreChangeFrom: "{previous} → {current}",
    improveTitle: "What would improve this match?",
    improveHint: "Based on the evidence you have now. Adding these does not guarantee a higher score.",
    confSources: "Independent sources",
    confVolume: "Evidence volume",
    confCoverage: "Requirement coverage",
    confProfile: "Profile completeness",
    confConsistency: "Consistency",
    sourceFILE: "File",
    sourceURL: "Link",
    sourcePROFILE: "Profile",
    page: "p. {page}",
    noAnalysis: "No advanced analysis for this match yet.",
    dimensionMustHaveSkills: "Must-have skills",
    dimensionExperienceDepth: "Experience depth",
    dimensionRoleSimilarity: "Role similarity",
    dimensionSeniorityFit: "Seniority fit",
    dimensionProjectEvidence: "Project evidence",
    dimensionLocationWorkMode: "Location & work mode",
    dimensionLanguageFit: "Language fit",
    dimensionNiceToHave: "Nice-to-have",
    compareTitle: "Comparison intelligence",
    bestTechnicalMatch: "Best technical match",
    bestSeniorityFit: "Best seniority fit",
    fewestMustHaveGaps: "Fewest must-have gaps",
