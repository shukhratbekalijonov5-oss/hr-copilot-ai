...
const uz: Dictionary = {
  ...
  matchInsight: {
    overallMatch: "Umumiy moslik",
    eligibility: "Muvofiqlik",
    evidenceConfidence: "Dalil ishonchliligi",
    confidenceHelp: "Ishonchlilik joriy dalillar ushbu bahoni qanchalik qo‘llab-quvvatlashini bildiradi. Bu ehtimollik emas.",
    confidenceParts: "Ishonchlilik tarkibi",
    scoreBreakdown: "Ball tafsiloti",
    requirementMatrix: "Talablar matritsasi",
    requirement: "Talab",
    priority: "Muhimlik",
    status: "Holat",
    evidence: "Dalil",
    eligible: "Mos",
    eligibilityPartial: "Qisman",
    blocked: "Mos emas",
    mustHave: "Majburiy",
    niceToHave: "Qo‘shimcha",
    strong: "Kuchli",
    match: "Mavjud",
    partial: "Qisman",
    missing: "Dalil yo‘q",
    statusBlocked: "To‘sqinlik",
    noCurrentEvidence: "Joriy dalil topilmadi",
    evidenceItems: "{count} ta tasdiqlovchi dalil",
    evidenceItem: "1 ta tasdiqlovchi dalil",
    transferableTitle: "O‘tkaziladigan dalil",
    transferableHint: "Talabni qisman qoplaydigan yaqin tajriba. To‘g‘ridan-to‘g‘ri moslik sifatida hisoblanmaydi.",
    transferableRelation: "{target} bilan qisman bog‘liq",
    contradictionsTitle: "Ziddiyatli dalil",
    contradictionsHint: "Ikki joriy manba turlicha ma’lumot beradi. Bu nomzod haqidagi hukm emas.",
    sourceA: "Birinchi manba",
    sourceB: "Ikkinchi manba",
    trajectoryTitle: "Karyera yo‘nalishi",
    trajectorySTRONG: "Kuchli",
    trajectoryALIGNED: "Mos",
    trajectoryMIXED: "Aralash",
    trajectoryWEAK: "Zaif",
    trajectoryUNKNOWN: "Noma’lum",
    scoreChangeTitle: "Moslik o‘zgardi",
    scoreChangeFrom: "{previous} → {current}",
    improveTitle: "Bu moslikni nima yaxshilaydi?",
    improveHint: "Hozirgi dalillaringizga asoslangan. Qo‘shish ball oshishini kafolatlamaydi.",
    confSources: "Mustaqil manbalar",
    confVolume: "Dalil hajmi",
    confCoverage: "Talablar qamrovi",
    confProfile: "Profil to‘liqligi",
    confConsistency: "Izchillik",
    sourceFILE: "Fayl",
    sourceURL: "Havola",
    sourcePROFILE: "Profil",
    page: "{page}-bet",
    noAnalysis: "Bu moslik uchun kengaytirilgan tahlil hali yo‘q.",
    dimensionMustHaveSkills: "Majburiy ko‘nikmalar",
    dimensionExperienceDepth: "Tajriba chuqurligi",
    dimensionRoleSimilarity: "Rol o‘xshashligi",
    dimensionSeniorityFit: "Daraja mosligi",
    dimensionProjectEvidence: "Loyiha dalillari",
    dimensionLocationWorkMode: "Joylashuv va ish rejimi",
    dimensionLanguageFit: "Til mosligi",
    dimensionNiceToHave: "Qo‘shimcha ko‘nikmalar",
    compareTitle: "Taqqoslash tahlili",
    bestTechnicalMatch: "Eng yaxshi texnik moslik",
    bestSeniorityFit: "Eng yaxshi daraja mosligi",
    fewestMustHaveGaps: "Eng kam majburiy bo‘shliq",
