...
const ru: Dictionary = {
  ...
  matchInsight: {
    overallMatch: "Общее соответствие",
    eligibility: "Допуск",
    evidenceConfidence: "Уверенность по данным",
    confidenceHelp: "Уверенность показывает, насколько текущие данные подтверждают эту оценку. Это не вероятность.",
    confidenceParts: "Из чего складывается уверенность",
    scoreBreakdown: "Разбор оценки",
    requirementMatrix: "Матрица требований",
    requirement: "Требование",
    priority: "Приоритет",
    status: "Статус",
    evidence: "Подтверждение",
    eligible: "Подходит",
    eligibilityPartial: "Частично",
    blocked: "Не подходит",
    mustHave: "Обязательно",
    niceToHave: "Желательно",
    strong: "Сильное",
    ...
    partial: "Частично",
    missing: "Нет данных",
    statusBlocked: "Блокирует",
    noCurrentEvidence: "Текущих подтверждений не найдено",
    evidenceItems: "Подтверждений: {count}",
    evidenceItem: "1 подтверждение",
    transferableTitle: "Смежный опыт",
    transferableHint: "Родственный опыт, частично покрывающий требование. Не засчитывается как прямое совпадение.",
    transferableRelation: "частичная связь с {target}",
    contradictionsTitle: "Противоречивые данные",
    contradictionsHint: "Два текущих источника сообщают разное. Это не суждение о кандидате.",
    sourceA: "Первый источник",
    sourceB: "Второй источник",
    trajectoryTitle: "Траектория карьеры",
    trajectorySTRONG: "Выраженная",
    trajectoryALIGNED: "Согласованная",
    trajectoryMIXED: "Смешанная",
    trajectoryWEAK: "Слабая",
    trajectoryUNKNOWN: "Неизвестна",
    scoreChangeTitle: "Соответствие изменилось",
    scoreChangeFrom: "{previous} → {current}",
    improveTitle: "Что улучшит это соответствие?",
    improveHint: "На основе имеющихся сейчас данных. Добавление не гарантирует рост оценки.",
    confSources: "Независимые источники",
    confVolume: "Объём данных",
    confCoverage: "Покрытие требований",
    confProfile: "Полнота профиля",
    confConsistency: "Непротиворечивость",
    sourceFILE: "Файл",
    sourceURL: "Ссылка",
    sourcePROFILE: "Профиль",
    page: "с. {page}",
    noAnalysis: "Расширенный анализ для этого соответствия пока отсутствует.",
    dimensionMustHaveSkills: "Обязательные навыки",
    dimensionExperienceDepth: "Глубина опыта",
    dimensionRoleSimilarity: "Схожесть роли",
    dimensionSeniorityFit: "Соответствие уровню",
    dimensionProjectEvidence: "Проектные подтверждения",
    dimensionLocationWorkMode: "Локация и формат работы",
    dimensionLanguageFit: "Языки",
    dimensionNiceToHave: "Желательные навыки",
    compareTitle: "Аналитика сравнения",
    bestTechnicalMatch: "Лучшее техническое соответствие",
    bestSeniorityFit: "Лучшее соответствие уровню",
    fewestMustHaveGaps: "Меньше всего пробелов",
