...
const ru: Dictionary = {
  ...
  notifications: {
    ...
    errors: {
      ...
      unavailable:
        "Уведомления временно недоступны. Повторите попытку чуть позже.",
  ...
  settings: {
    ...
    accountEmailNote:
      "Важные письма об аккаунте и подписке отправляются на адрес почты вашего аккаунта.",
    fullName: "Имя и фамилия",
    email: "Эл. почта",
    organization: "Организация",
  ...
  home: {
    entries: {
      internalHint: "Ранжируйте все открытые вакансии HR Copilot по вашим данным.",
      externalHint: "Ищите вакансии на собственных карьерных сайтах работодателей.",
    },
    banner: {
      title: "Больше данных — точнее подбор",
      description:
        "AI-подбор читает ваше резюме, ссылки и профиль. Чем больше материала, тем точнее каждое ранжирование.",
      action: "Дополнить профиль",
    },
    title: "Ваш поиск работы",
    greeting: "С возвращением, {name}",
    subtitle:
      "Всё, на чём строятся ваши отклики и AI-подборки, — в одном месте.",
    findMatchingJobs: "Найти подходящие вакансии",
    updateResume: "Обновить резюме",
    readiness: {
      title: "Готовность профиля",
      summary: "{done} из {total} готово",
      complete: "Готово",
      allDone: "Профиль готов к подбору вакансий.",
      resume: "Добавьте резюме",
      resumeHint: "Резюме — главный источник, который читает AI-подбор.",
      resumeDone: "Резюме загружено",
      links: "Добавьте ссылку на портфолио",
      linksHint: "GitHub, личный сайт или любые публичные работы.",
      linksDone: "Ссылка на портфолио добавлена",
      preferences: "Укажите пожелания к работе",
      preferencesHint: "Расскажите, что ищете, — подборка станет точнее.",
      preferencesDone: "Пожелания указаны",
      profile: "Заполните профиль",
      profileHint: "Заголовок и несколько навыков помогут вас понять.",
      profileDone: "Данные профиля добавлены",
      add: "Добавить",
    },
    stats: {
      activeApplications: "Активные отклики",
      activeApplicationsHint: "Ещё на рассмотрении у работодателя.",
      savedJobs: "Сохранённые вакансии",
      savedJobsHint: "Ваш короткий список.",
      evidence: "Источники подтверждений",
      evidenceHint: "Файлы и ссылки, которые читает AI-подбор.",
      strongMatches: "Сильные совпадения",
      strongMatchesHint: "Роли, которые хорошо подтверждены вашими данными.",
    },
    pipeline: {
      title: "Ход откликов",
      description: "На каком этапе находятся ваши отклики сейчас.",
      applied: "Отправлено",
      review: "На рассмотрении",
      interview: "Собеседование",
      decision: "Решение",
      empty: "Откликов пока нет",
      emptyHint: "Вакансии, на которые вы откликнетесь, появятся здесь с этапом.",
      viewAll: "Все отклики",
    },
    matches: {
      title: "Лучшие AI-совпадения",
      description: "Ранжировано по данным вашего профиля.",
      viewAll: "Все совпадения",
      view: "Открыть совпадение",
      sourceInternal: "HR Copilot",
      sourceExternal: "Внешние",
      empty: "Совпадений пока нет",
      emptyHint:
        "Добавьте резюме или ссылку на портфолио, затем запустите AI-подбор.",
      unavailable: "Не удалось загрузить совпадения",
      unavailableHint: "Откройте AI-подбор вакансий и попробуйте снова.",
      lockedHint:
        "AI-подбор сопоставляет каждую открытую вакансию с вашими данными.",
      run: "Открыть AI-подбор вакансий",
      needsEvidence: "Сначала добавьте данные",
    },
    recent: {
  ...
  recruiterPlans: {
    title: "Тарифы для рекрутеров",
    description: "Тарифы с AI-поиском кандидатов для рекрутеров скоро появятся.",
    comingSoon: "Скоро",
    previewNotice:
      "Эта страница — предпросмотр того, куда движется HR Copilot для рекрутеров. Купить пока ничего нельзя, и ни один тариф для рекрутеров не активен в вашем пространстве.",
    currentlyIncluded: "Доступно сейчас",
    planned: "Планируется",
    pricingComingSoon: "Цены будут позже",
    free: "$0",
    perMonth: "в месяц",
    tiers: {
      FREE: {
        name: "Free",
        tagline: "Всё, чем ваша команда пользуется в HR Copilot сегодня.",
        features: [
          "Создание и ведение вакансий",
          "Приём и разбор откликов",
          "Подтверждения кандидатов и AI-поиск",
          "Чаты собеседований и сравнение кандидатов",
        ],
      },
      PRO: {
        name: "Pro",
        tagline: "Планируется: находить кандидатов помимо тех, кто откликнулся.",
        features: [
          "Внешний AI-поиск кандидатов",
          "Поиск кандидатов на основе вакансии",
          "AI-ранжирование кандидатов по одной вакансии",
          "Поиск с учётом источника",
          "Расширенные объяснения соответствия",
        ],
      },
      MAX: {
        name: "Max",
        tagline: "Планируется: поиск сразу по нескольким внешним источникам.",
        features: [
          "Всё, что планируется в Pro",
          "AI-поиск по нескольким источникам",
          "Поиск кандидатов между источниками",
          "Расширенное сравнение кандидатов",
          "Аналитика поиска",
          "Приоритетные AI-процессы",
        ],
      },
    },
    sourcing: {
      title: "AI-поиск кандидатов — скоро",
      description:
        "Планируемый сценарий: вы выбираете вакансию, а HR Copilot ищет во внешних источниках подходящие профили и ранжирует их по этой вакансии.",
      steps: [
        "Выберите вакансию",
        "HR Copilot AI",
        "Поиск по планируемым внешним источникам",
        "Ранжирование подходящих кандидатов",
        "Разбор подтверждений",
      ],
      sourcesTitle: "Планируемые источники",
      sourcesNote:
        "По этим источникам пока нельзя искать. Это описание намеченного направления, а не существующей функции.",
    },
    roadmap: {
      title: "Скоро появится больше AI-инструментов для рекрутеров.",
      description:
        "Будущие релизы расширят AI-поиск и подбор кандидатов на основе вакансий.",
    },
  },
  ...
  plans: {
    ...
    notReported: "Сервер не сообщил текущий тариф.",
    noCheckoutNote:
      "Оплата пока недоступна, поэтому купить тариф на этой странице нельзя. Страница показывает, что входит в каждый тариф.",
    planOptions: "Варианты тарифов",
    planOptionsDescription:
      "Платное повышение открывает checkout. Текущий тариф изменится только после того, как backend сообщит новый статус.",
    capabilities: "Возможности",
    features: "Функции",
    noPaidCapabilities: "Платных AI-возможностей нет.",
    capabilityNames: {
      INTERNAL_AI_SEARCH: "Внутренний AI-поиск вакансий",
      EXTERNAL_AI_SEARCH: "Внешний AI-поиск вакансий",
    },
    actions: {
      upgradeTo: "Перейти на {plan}",
      downgradeTo: "Понизить до {plan}",
      choosePlan: "Выбрать {plan}",
      paymentSetupComingSoon: "Настройка оплаты скоро появится.",
      checkoutHint: "Перед переходом к checkout нужно подтвердить действие.",
      downgradeUnavailable: "Понижение тарифа здесь пока недоступно.",
      freePlanNoCheckout: "Бесплатный тариф не требует checkout.",
    },
    demoCheckout: {
      title: "Оплата",
      demoBadge: "Демо-оплата",
      openDemo: "Демо-оплата — {plan}",
      demoModeNote:
        "Демо портфолио. Меняет тариф для демонстрации через безопасное переключение — карта не списывается и платёж не создаётся.",
      brand: "HR Copilot AI",
      ...
      expiry: "Срок (ММ/ГГ)",
      cvc: "CVC",
      saveCard: "Сохранить карту на будущее",
      pay: "Оплатить ${amount}",
      close: "Закрыть оплату",
      demoNote:
        "Демо-оплата. Данные карты не отправляются, не сохраняются и не логируются — они остаются в этом браузере и стираются при закрытии окна.",
      realCheckoutNote:
        "В этой среде используется реальный платёжный провайдер. Продолжите оплату на его странице.",
      continueToProvider: "Перейти к оплате",
      successTitle: "Оплата прошла",
      successBody: "План {plan} активен. Состояние плана заново получено с сервера.",
      done: "Готово",
      errors: {
        required: "Обязательное поле.",
        invalidCardNumber: "Введите номер карты из 13–19 цифр.",
        invalidExpiry: "Формат ММ/ГГ.",
        invalidCvc: "Введите 3 или 4 цифры.",
        formInvalid: "Проверьте отмеченные поля.",
      },
    },
    checkout: {
      confirmTitle: "Начать checkout для {plan}?",
      chargedAsKrw: "${usd}/мес — списывается ₩{krw} через Toss.",
      confirmDescription:
        "{plan} стоит {price}. Далее вы перейдёте к платёжному провайдеру. Тариф не изменится, пока backend не подтвердит оплату.",
      continue: "Перейти к оплате",
      errors: {
        invalidTransition: "Такое изменение тарифа пока недоступно.",
        unauthenticated: "Войдите снова, чтобы продолжить.",
        forbidden: "Этот аккаунт не может начать checkout.",
        routeUnavailable: "Checkout недоступен в этой среде.",
        conflict: "Checkout уже выполняется. Попробуйте ещё раз чуть позже.",
        paymentUnavailable:
          "Платёжный сервис временно недоступен. Попробуйте чуть позже.",
        checkoutUnavailable: "Checkout сейчас недоступен. Попробуйте чуть позже.",
      },
    },
    billing: {
      title: "Сводка оплаты",
      ...
      backendCapabilities: "Возможности от backend",
      unknownStatus: "Статус: {status}",
      ...
      errors: {
        billingUnavailable:
          "Информация об оплате временно недоступна. Попробуйте чуть позже.",
        unauthenticated: "Войдите снова, чтобы посмотреть оплату.",
        forbidden: "Этот аккаунт не может смотреть оплату.",
      },
    },
    devSwitch: {
      title: "Демо-переключатель тарифа",
      description:
        "Меняет тариф только для демонстрации — оплата не проводится и карта не списывается. Переключатель обращается к backend, затем заново читает оплату и доступ, и только после этого меняет страницу.",
      portfolioDemo: "Демо портфолио",
      switchTo: "Переключить на {plan}",
      confirmTitle: "Переключить на {plan}?",
      confirmDescription:
        "Страница дождётся backend-ответа и затем заново прочитает авторитетное состояние оплаты и возможностей.",
      confirm: "Переключить тариф",
      switching: "Переключаем тариф...",
      planUpdated: "Тариф обновлён по состоянию backend.",
      alreadyOnThisPlan: "Вы уже на этом тарифе.",
      errors: {
        invalidTransition: "Такое переключение тарифа недоступно.",
        unauthenticated: "Войдите снова, чтобы переключить тариф.",
        forbidden: "Этот аккаунт не может переключать тариф.",
        routeUnavailable: "Демо-переключатель тарифа не включён на этом сервере.",
        conflict: "Переключение конфликтует с текущим состоянием оплаты.",
        paymentUnavailable:
          "Платёжный сервис временно недоступен. Попробуйте чуть позже.",
        refreshFailed:
          "Переключение завершилось, но страницу не удалось обновить. Попробуйте снова.",
        switchUnavailable: "Переключение тарифа сейчас недоступно.",
      },
    },
    locked: {
      INTERNAL_AI_SEARCH: {
