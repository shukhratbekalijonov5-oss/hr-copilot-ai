...
const ru: Dictionary = {
  ...
  plans: {
    ...
    demoCheckout: {
      ...
      devOnlyNote:
        "Только для разработки. Использует существующее безопасное переключение плана: карта не списывается и платёж не создаётся.",
      brand: "HR Copilot AI",
    ...
    devSwitch: {
      ...
      description:
        "Только для dev/test. Переключатель обращается к NestJS BFF, затем обновляет оплату и auth, и только после этого меняет страницу.",
      devOnly: "Только development",
      ...
      errors: {
        ...
        routeUnavailable: "Developer Plan Switch здесь недоступен.",
